...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: "ardhefourteenz",                           // [string or array] required unless using the 'query' option; one or more twitter screen names (use 'list' option for multiple names, where possible)
