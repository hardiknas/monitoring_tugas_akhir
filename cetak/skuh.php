...
if (empty($_SESSION['sesId'])&&(empty($_SESSION['uId']))){
	...
	$dsp = getData("*","ujian_hasil","sId='$sid'");
	...
	$content = "
				...
				<hr>
					...
					<p>
						Dengan Rahmat Allah SWT, Sehubungan dengan pelaksanaan <b>UJIAN HASIL</b> 
						...
						Menetapkan Tim Penguji Ujian Hasil Sebagai Berikut :
					</p>
					<p>
						<b>PEMBIMBING : </b>
						<ol type='1'>
    					...
    					Bertugas melaksanakan Ujian Hasil bagi mahasiswa :
					</p>
