...
if (empty($_SESSION['sesId'])){
	...
	$filename="Laporan Pelaksanaan Ujian Hasil $jthn $jjur.pdf";
	...
	$content = "
				...
				<hr>
				<br><p align='center'><b><u>LAPORAN PELAKSANAAN UJIAN HASIL<br>$jthn $jjur</u></b></p>
				<br>
			...
			";
			$no = 0;
			$query = mysql_query("SELECT a.*,b.* FROM ujian_hasil a
