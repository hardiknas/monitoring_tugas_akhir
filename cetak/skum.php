...
if (empty($_SESSION['sesId'])&&(empty($_SESSION['uId']))){
	...
	$dsp = getData("*","ujian_meja","sId='$sid'");
	...
	$content = "
				...
				<hr>
					...
					<p>
						Dengan Rahmat Allah SWT, Sehubungan dengan pelaksanaan <b>UJIAN MEJA</b> 
						...
						Menetapkan Tim Penguji Ujian Meja Sebagai Berikut :
					</p>
					<p>
						<b>PEMBIMBING : </b>
						<ol type='1'>
    					...
    					Bertugas melaksanakan Ujian Meja bagi mahasiswa :
					</p>
