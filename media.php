...
if ((!$_SESSION['uId'])||($_SESSION['uLevel']==1)){
...
<head>
		<meta charset="utf-8" />
		<title>Dashboard | <?php echo $_CONFIG['appname'];?></title>
			...
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<ul class="nav ace-nav pull-right">
                     ...
                     ?>
								<?php
								if (empty($_SESSION['uFoto'])){
								?>
									<img class="nav-user-photo" src="images/photo.jpg" alt="<?php echo $_SESSION['uNama'];?>">
								<?php
								}else{
								?>
									<img class="nav-user-photo" src="<?php echo $mfoto;?>" alt="<?php echo $_SESSION['uNama'];?>">
								<?php
								}
								?>
								<span class="user-info">
									<small>Selamat Datang,</small><?php echo $_SESSION['uNama'];?>
								</span>
