...
<div class="span12">
	...
	<tbody>
	 <?php
	 	$qry = mysql_query("SELECT a.*,b.sJudul FROM ujian_meja a
		...
		while ($d = mysql_fetch_array($qry)){
	      ...
	      <td class='center'>";
	      	$sid = $d['sId']
	      	?>
	      	<button class='btn btn-primary btn-mini' onclick="NewWindow('../cetak/skum.php?sid=<?php echo $sid;?>','ZoomIn','850','550','yes');return false">
